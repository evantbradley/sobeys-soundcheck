...
import { 
  ...
  Award, Minus, Plus, Activity, User, Volume2, Shield
} from 'lucide-react';
...
const useAudioEngine = () => {
  ...
  // Google's Open Source Sound Library (Never blocks hotlinking)
  const startEnvironmentalTest = (type, volumeLevel) => {
    initAudio();
    stopAll();
    
    const url = type === 'high' 
      ? 'https://actions.google.com/sounds/v1/animals/small_flock_of_birds.ogg' 
      : 'https://actions.google.com/sounds/v1/science_fiction/low_frequency_hum.ogg';
  ...
  const startCafeSimulation = () => {
    ...
    if (!backgroundAudioRef.current) {
      const audio = new Audio('https://actions.google.com/sounds/v1/crowds/restaurant_ambience.ogg');
      audio.crossOrigin = "anonymous";
      audio.loop = true;
    ...
    // slight delay to let background noise set in
      ...
      <main className="max-w-5xl w-full flex flex-col justify-center items-center relative z-10 pb-12 mt-12">
        ...
        {currentFlow === 'instore' && step === 1 && (
          <div className="w-full flex flex-col items-center animate-fade-in">
            ...
            <p className="text-4xl font-light leading-tight opacity-90 max-w-3xl text-center">"I find that the TV volume frequently causes disagreements at home, or I rely heavily on subtitles."</p>
            <LikertButtons />
          </div>
        )}
        ...
        {currentFlow === 'instore' && step === 2 && (
          <div className="w-full flex flex-col items-center animate-fade-in">
            ...
            <p className="text-4xl font-light leading-tight opacity-90 max-w-3xl text-center">"In a lively restaurant or family gathering, I struggle to follow the conversation and catch the punchlines."</p>
            <LikertButtons />
          </div>
        )}
        ...
        {currentFlow === 'instore' && step === 3 && (
          <div className="w-full flex flex-col items-center animate-fade-in">
            ...
            <p className="text-4xl font-light leading-tight opacity-90 max-w-3xl text-center">"I find myself avoiding social gatherings or noisy environments because listening takes too much energy."</p>
            <LikertButtons />
          </div>
        )}
        ...
        {currentFlow === 'instore' && step === 5 && (
          <div className="space-y-8 animate-fade-in w-full max-w-3xl flex flex-col items-center">
            <p className="text-2xl font-light text-[#3E3E3E] mb-2 px-8">High frequencies (like birdsongs) are usually the first sounds to fade. Tap the <strong className="font-bold">minus</strong> button until the birds disappear, then tap <strong className="font-bold">plus</strong> just until you can hear them.</p>
        ...
        {currentFlow === 'instore' && step === 6 && (
          <div className="space-y-8 animate-fade-in w-full max-w-3xl flex flex-col items-center">
            <p className="text-2xl font-light text-[#3E3E3E] mb-2 px-8">Low frequencies carry the power of human speech. Tap the <strong className="font-bold">minus</strong> button until the deep hum disappears, then tap <strong className="font-bold">plus</strong> just until you can hear it.</p>
            <div className="bg-white p-10 rounded-[3rem] shadow-xl border border-[#1B5234]/10 w-full flex flex-col items-center">
              <div className="flex items-center justify-center gap-12 w-full mb-10">
